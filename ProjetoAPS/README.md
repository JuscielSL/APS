...
### 👥 **WHO** (Quem?)
- **Desenvolvedor(es):** Jusciel, David Brito ,Felipe Nascimento, Gecinaldo, Kevin e André.
...
### 📍 **WHERE** (Onde?)
- **Localização do Repositório:** [GitHub - APS](https://github.com/JuscielSL/APS)
...
Para dúvidas sobre o projeto, abra uma [issue](https://github.com/JuscielSL/APS) no repositório.
